 ...
 */
export function union<T extends any[] | Set<any>> (a: T, b: T): T {
 ...
 */
export function intersection<T extends any[] | Set<any>> (a: T, b: T): T {
  if (Array.isArray(a) && Array.isArray(b)) {
 ...
 */
export function without<T extends string | any[] | Set<any>> (element: T, ...values: any[]): T {
 ...
 */
export function symDiff<T extends any[] | Set<any>> (a: T, b: T): T {
  const firstArray = [...a]
  const secondArray = [...b]
  const result = []
